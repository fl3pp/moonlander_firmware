...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_BASE] = LAYOUT_moonlander(
    ...
    n____,        KC_Y,         KC_X,       KC_C,         LT(L_NAV,KC_V),KC_B,                                                   LT(L_NAV,KC_N),KC_M,        KC_COMMA,     KC_DOT,       KC_SLASH,     n____,
  ...
  [L_NAV] = LAYOUT_moonlander(
    _____,        _____,        _____,        _____,        _____,        _____,        _____,                     _____,        _____,        _____,        _____,        _____,        _____,        _____,
    _____,        _____,        KC_HOME,      KC_UP,        KC_END,       _____,        _____,                     _____,        _____,        _____,        _____,        _____,        _____,        _____,
    _____,        _____,        KC_LEFT,      KC_DOWN,      KC_RIGHT,     _____,        _____,                     _____,        KC_LEFT,      KC_DOWN,      KC_UP,        KC_RIGHT,     _____,        _____,
